...
class PostureCorrectionAdapter(internal var context: Context) :
    RecyclerView.Adapter<PostureCorrectionAdapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val rowSideMenuBinding = DataBindingUtil.inflate<ItemPostureCorrectionBinding>(
            inflater,
            R.layout.item_posture_correction, parent, false)
    ...
    inner class MyViewHolder(internal var rowSideMenuBinding: ItemPostureCorrectionBinding) :
