...
import com.stretching.databinding.ItemWorkoutListBinding
import com.stretching.databinding.ItemWorkoutStatusIndicatorBinding
        ...
        try {
            if (position <= (completedEx - 1)) {
                holder.rowSideMenuBinding.viewIndicator.background =
                    ContextCompat.getDrawable(context, R.color.green_text)
            } else {
                holder.rowSideMenuBinding.viewIndicator.background =
